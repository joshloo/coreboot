...
QDEF(MP_QSTR_load_file, (const byte*)"\x5a\x09" "load_file")
...
QDEF(MP_QSTR_save_cfgd, (const byte*)"\x7d\x09" "save_cfgd")
...
QDEF(MP_QSTR_uart_write, (const byte*)"\x35\x0a" "uart_write")
QDEF(MP_QSTR_ucollections, (const byte*)"\x15\x0c" "ucollections")
QDEF(MP_QSTR_utime, (const byte*)"\xe5\x05" "utime")
QDEF(MP_QSTR_IA32, (const byte*)"\x8c\x04" "IA32")
QDEF(MP_QSTR_X64, (const byte*)"\x3f\x03" "X64")
